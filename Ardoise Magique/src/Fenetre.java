...
public class Fenetre extends JFrame {
	...
	JButton square = new JButton(new ImageIcon("src/images/Carre_noir.png"));
	JButton	circle = new JButton(new ImageIcon("src/images/Rond_noir.jpg"));
	JButton	red = new JButton(new ImageIcon("src/images/Carre_rouge.jpg"));
	JButton	green = new JButton(new ImageIcon("src/images/Carre_vert.jpg"));
	JButton	blue = new JButton(new ImageIcon("src/images/Carre_bleu.jpg"));
